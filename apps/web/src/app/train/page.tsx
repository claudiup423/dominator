...
const STYLES = [
  {
    ...
    label: "Passive",
    emoji: "🐢",
    desc: "Patient, waits for mistakes, predictable clears",
  ...
  },
  {
    ...
    label: "Aggro",
    emoji: "🔥",
    desc: "High pressure, fast challenges, relentless",
  ...
  },
  {
    ...
    label: "Counter",
    emoji: "🧠",
    desc: "Baits, fakes, punishes over-commits",
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-dom-muted mt-1">
          Choose your mode, difficulty, and opponent. Then hit the field.
        </p>
      </div>
